...
chkfmt = function(chk_str) {
 ...
 MixedtoProper = (num1, num2, num3)=>{
	 ...
	 part1 = Number(Number(num1)*Number(num3))+Number(num2);
	 part2 = num3;
...
ForElementFun = (num1, num2, num3, num4)=>{
	 
	 LCM = getLCM(num2,num4);
	 frac1 = (LCM/num2)*num1;
	 frac2 = (LCM/num4)*num3;
	 part1 = Number(frac1)+Number(frac2);
	 part2 = LCM;
 ...
 forArrG = (num1)=>{
	if(String(num1).length == 1 && num1%1==0){
		return true;
	}
	else if(String(num1).length == 2 && num1%10==0){
		 return true;	 
	 }
 }
